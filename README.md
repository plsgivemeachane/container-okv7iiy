...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-okv7iiy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-okv7iiy.containers.anotherwebservice.com/
...
```
git clone git@github.com:plsgivemeachane/container-okv7iiy.git
cd container-okv7iiy
```
...
```
docker attach container-okv7iiy
```
